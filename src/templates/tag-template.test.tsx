...
describe("TagTemplate", () => {
  ...
  test("head renders correctly", () => {
    ...
    expect(getMeta(container, "twitter:title")).toEqual("Typography - Page 2 - Blog by Forzen Wu");
    expect(getMeta(container, "og:title")).toEqual("Typography - Page 2 - Blog by Forzen Wu");
