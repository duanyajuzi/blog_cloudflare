...
describe("PostTemplate", () => {
  ...
  test("head renders correctly", () => {
    ...
    expect(getMeta(container, "twitter:title")).toEqual("Humane Typography in the Digital Age - Blog by Forzen Wu");
    expect(getMeta(container, "og:title")).toEqual("Humane Typography in the Digital Age - Blog by Forzen Wu");
